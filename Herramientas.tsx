    ...
    <section id="herramientas" className={styles.section}>
      ...
      <div className={styles.container}>
        <div className={styles.heading}>
          <span className={styles.kicker}>¿POR QUÉ ELEGIR WEBCREATOR?</span>
          ...
          <p className={styles.subtitle}>
            Cada desarrollo está pensado para ahorrar tiempo, mejorar la experiencia
            del cliente y <strong>aumentar las ventas</strong> de tu negocio.
          </p>
        </div>
      </div>
    </section>
